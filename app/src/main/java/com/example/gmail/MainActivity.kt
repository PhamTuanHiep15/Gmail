...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(OutData(R.mipmap.image_e_round, "Edurila.com","12:34 PM","$19 Only (First 10 spots)...", "Are you looking to Learn Web Designin..."))
        ...
        list.add(OutData(R.mipmap.image_e_round, "Edurila.com","9:02 AM","$19 Only (First 10 spots)...", "Are you looking to Learn Web Designin..."))
